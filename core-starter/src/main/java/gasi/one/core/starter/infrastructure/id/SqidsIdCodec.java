package gasi.one.core.starter.infrastructure.id;
 ...
 */
@Component
public class SqidsIdCodec implements IdCodec {

    private final Sqids sqids;

    /**
     * Creates a codec using the configured Sqids alphabet.
     *
     * @param alphabet configured Sqids alphabet from {@code app.id.salt}
     */
    public SqidsIdCodec(@Value("${app.id.salt}") String alphabet) {
