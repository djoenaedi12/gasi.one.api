package gasi.one.core.api.plugin;
...
public interface I18nExtension extends ExtensionPoint {
     ...
     * packaged together on one classpath. Generated CRUD plugins can follow
     * {@code src/main/resources/i18n/{pluginName}/{fileName}.properties} and
     * return the matching basename, such as
     * {@code classpath:i18n/auth/messages}.
     * </p>
     *
     * <p>
     * Plugins may return multiple basenames when generated messages and custom
     * message bundles are stored in different folders.
     * </p>
     *
     * <p>
     ...
     * <li>{@code i18n/auth/custom/errors.properties} &mdash; optional custom
     * bundle</li>
     * </ul>
     *
