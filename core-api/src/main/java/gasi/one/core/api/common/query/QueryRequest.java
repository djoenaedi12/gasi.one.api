package gasi.one.core.api.common.query;
...
public class QueryRequest {
    ...
    /**
     * Optional response projection for query list/page endpoints.
     *
     * <p>
     * When provided, only these public DTO fields are returned. Controllers
     * may force required fields such as {@code id} to remain present.
     * </p>
     */
    ...
    /**
     * Creates an empty query request.
     */
    public QueryRequest() {
    }
