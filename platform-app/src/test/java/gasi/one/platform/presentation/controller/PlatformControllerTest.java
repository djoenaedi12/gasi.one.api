package gasi.one.platform.presentation.controller;
...
import gasi.one.core.api.plugin.AppExtension;
import gasi.one.platform.bootstrap.PluginMetadataRegistry;
...
class PlatformControllerTest {
    ...
    void healthShouldIncludePluginModuleMetadata() {
        ...
        when(extension.getBasePackages()).thenReturn(List.of("gasi.one.plugins.auth"));
        when(pluginManager.getStartedPlugins()).thenReturn(List.of());
        ...
        assertThat(basePackages).containsExactly("gasi.one.plugins.auth");
